...
public class ValidateImportUser {
    ...
    public static List<String> validateRow(Row row, Map<Integer, String>headerMapValue){

        
        String indexUsername = headerMapValue.get("Tên");
        String indexRole= headerMapValue.get("Vai trò");


        String username = row.getCell(indexUsername);
        String role = row.getCell(indexRole);
